...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                <div class="card-body">
                    <center class="m-t-30"> <img src="../../update/img/avata/{{Auth::user()->avatar}}" class="rounded-circle" width="150" />
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('user.update', ['id' => Auth::user()->id])}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="date" name="ngaySinh" required value="{{ Auth::user()->ngaySinh }}" class="form-control form-control-line">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Giới Tính</label>
                            <div class="col-md-12">
                                <select class="custom-select col-12" name="gioTinh" id="inlineFormCustomSelect">
                                    <option selected>Chọn giới tính</option>
                                    @if( Auth::user()->gioTinh==1)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea rows="5" name="diaChi" class="form-control form-control-line">{{ Auth::user()->address }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Avatar</label>
